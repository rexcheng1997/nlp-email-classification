...
def analyze(df):
    stopWords = ENGLISH_STOP_WORDS.union(["ees", "com", "et", "hou", "ect", "-e-", "na", "br", "subject", "mail", "forwarded", "thanks"])
    vect = TfidfVectorizer(analyzer='word', stop_words=stopWords, max_df=0.99, min_df=2)
